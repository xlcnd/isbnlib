...
from ._core import (is_isbn10, is_isbn13, to_isbn10, to_isbn13, clean,
                    ...
                    GTIN13, EAN13, RE_ISBN10, RE_ISBN13, RE_LOOSE,
                    RE_NORMAL, RE_STRICT)
...
__all__ = (
    'is_isbn10', 'is_isbn13', 'clean', 'mask', 'info', 'meta', 'to_isbn10',
    'to_isbn13', 'get_isbnlike', 'notisbn', 'ean13', 'EAN13', 'cover', 'desc',
    'canonical', 'get_canonical_isbn', 'editions', 'isbn_from_words',
    'quiet_errors', 'config', '__version__', '__support__', 'doi', 'ren',
    'ISBN13', 'ISBNLibException', 'NotRecognizedServiceError',
    'NotValidISBNError', 'PluginNotLoadedError', 'goom', 'doi2tex', 'RDDATE')

__version__ = '3.6.7'  # <-- literal IDs
